...
?>
<!-- editor
<script src="<?php echo base_url(); ?>assets/plugin/editor/nicEdit.js"></script>
 -->
...
console.log("<?php echo base_url(); ?>assets/js/aplikasi.js?time=<?php echo time(); ?>");
console.log("heree");
...
<!-- <script> console.log("<?php echo base_url(); ?>assets/js/aplikasi.js?time=<?php echo time(); ?>");</script> -->
