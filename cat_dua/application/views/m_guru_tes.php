          ...
          <form name="f_ujian" id="f_ujian" onsubmit="return m_ujian_s();">
            ...
            <input type="hidden" name="jumlah_soal1" id="jumlah_soal1" value="0">
              <table class="table table-form">
                ...
                <tr><td>Tipe Soal Tertuju</td><td><?php echo form_dropdown('mapel', $p_mapel, '', 'class="form-control"  id="mapel" required'); ?></td></tr>
                ...
                <tr><td>Tgl Mulai</td><td>
                  ...
                  <input type="time" name='wkt_mulai' class="form-control" style="width: 130px; display: inline; float: left" id="wkt_mulai" placeholder="Waktu" required>
                </td></tr>
                <tr><td>Tgl Selesai</td><td>
                  ...
                  <input type="time" name='terlambat2' class="form-control" style="width: 130px; display: inline; float: left" id="terlambat2" placeholder="Waktu" required>
                </td></tr>
